  ...
  return (
    <Layout>
      <div className={styles.terminalPage}>
        ...
        <h2 style={{ fontSize: '1.2rem', fontWeight: 600, marginTop: '2rem', marginBottom: '0.75rem', color: 'var(--color-ink)' }}>What you just saw</h2>
        <ol style={{ color: 'var(--color-graphite)', lineHeight: 1.8, paddingLeft: '1.5rem' }}>
