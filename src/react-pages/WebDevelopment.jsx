    ...
    <Layout>
      <div className={styles.page}>
        ...
        <p style={{ color: 'var(--color-graphite)', marginBottom: '1.5rem', lineHeight: 1.7 }}>
          How a web development team uses OpenFlows on top of their Coder environment to ship features and fix bugs faster — with five AI agents handling the entire pipeline from GitHub issue to merged PR, safely and with full governance.
        </p>
        ...
        <h2 style={{ fontSize: '1.2rem', fontWeight: 600, marginTop: '2rem', marginBottom: '0.75rem', color: 'var(--color-ink)', borderBottom: '1px solid var(--color-driftwood)', paddingBottom: '0.5rem' }}>The Pipeline in Practice</h2>
