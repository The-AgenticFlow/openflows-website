...
import styles from '../pages/developers/Developers.module.css'
...
const CARDS = [
  ...
  { icon: '⭐', title: 'GitHub Repository ↗', desc: 'Full source code, issues, discussions, and releases. MIT licensed. Built in Rust with Tokio, reqwest, and fred (Redis).', href: 'https://github.com/The-AgenticFlow/OpenFlows' },
    ...
    <Layout>
      <section className={styles.hero}>
        <div className={styles.container}>
          ...
          <p className={styles.sub}>Everything you need to integrate with OpenFlows - integration guides, architecture docs, and the full source code on GitHub.</p>
        </div>
      </section>
