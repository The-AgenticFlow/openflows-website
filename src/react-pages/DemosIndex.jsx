    ...
    <Layout>
      <section className={styles.hero}>
        <div className={styles.container}>
          ...
          <p className={styles.sub}>Watch the full autonomous pipeline — from open GitHub issue to merged, documented pull request — running on top of your Coder environment, with no human intervention.</p>
        </div>
      </section>
