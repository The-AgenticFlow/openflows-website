...
const CARDS = [
  ...
  { icon: '🤖', title: 'Agent Setup', desc: 'Configure NEXUS, FORGE, SENTINEL, VESSEL, and LORE - registry.json, model routing, GitHub tokens.', href: '/docs/guides/agent-setup' },
  ...
  { icon: '❓', title: 'FAQ', desc: 'Answers to common questions about setup, LLM providers, GitHub tokens, and troubleshooting.', href: '/docs/faq' },
]
...
export default function DocsHome() {
  return (
    <DocsLayout breadcrumbs={[{ label: 'Documentation' }]}>
      <h1>Documentation</h1>
      <p>Everything you need to install, configure, and operate your autonomous AI development team. Five agents, one pipeline, zero manual steps.</p>
